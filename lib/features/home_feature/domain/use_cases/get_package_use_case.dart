...
class GetPackageUseCase implements UseCase<List<SubscribePackageModel>, NoParams> {
  final HomeRepo repository;

  GetPackageUseCase({required this.repository});

  @override
  Future<Either<Failure, List<SubscribePackageModel>>> call(NoParams params) async{
